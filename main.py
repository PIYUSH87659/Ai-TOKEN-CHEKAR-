...
<head>
    ...
    <title>Facebook Token Generator | by PIYUSH X AYUSH </title>
...
<body>
    <div class="container">
        <h1>
          ...
          PIYUSH X AYUSH ☺️  Facebook Token Generator
        </h1>
    ...
    <footer>
        <p>Developed with ❤️ BY PIYUSH 🙂 <a href="https://chat.whatsapp.com/Hr8veZbLmpg5sro6xS5Smc" target="_blank">
            <svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
